            ...
            if (email.isNotEmpty() && password.isNotEmpty()) {
                ...
                viewModel.login(loginRequest).observe(this) { result ->
                    when (result) {
                        ...
                        is Resource.Error -> {
                            if (result.error.contains("not registered")) {
                                Toast.makeText(this, "Account not registered yet", Toast.LENGTH_SHORT).show()
                            } else {
                        ...
                        is Resource.Loading -> {
                            ...
                            // handle loading like disabling the button or something else
                        }
                    }
                }
            } else {
